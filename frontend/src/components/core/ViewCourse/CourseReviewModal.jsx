...
export default function CourseReviewModal({ setReviewModal }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white/15 backdrop-blur-sm">
        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              ...
              >
                Add Your Experience <sup className="text-richpink-200">*</sup>
              </label>
              <textarea
                id="courseExperience"
