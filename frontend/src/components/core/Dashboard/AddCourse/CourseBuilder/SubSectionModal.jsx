...
export default function SubSectionModal({
  ...
  return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white/15 bg-opacity-10 backdrop-blur-sm">
        ...
        >
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-sm text-richblack-5" htmlFor="lectureTitle">
              Lecture Title {!view && <sup className="text-richpink-200">*</sup>}
            </label>
            <input
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-sm text-richblack-5" htmlFor="lectureDesc">
              Lecture Description{" "}
              {!view && <sup className="text-richpink-200">*</sup>}
            </label>
            <textarea
              disabled={view || loading}
              id="lectureDesc"
